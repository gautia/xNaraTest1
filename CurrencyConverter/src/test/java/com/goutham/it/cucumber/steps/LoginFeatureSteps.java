...
public class LoginFeatureSteps extends AbstractStepDef
{
    ...
    {
		browser.findElement(By.name(CurrencyConverterConstants.USERNAME)).sendKeys(loginInfo.get(1).get(0));
		browser.findElement(By.name(CurrencyConverterConstants.PASSWORD)).sendKeys(loginInfo.get(1).get(1));
